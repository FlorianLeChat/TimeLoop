...
export const eventsByRegion: Record<string, EventProperties[]> = {
	"Europe": [
		...
		{ label: "Magna Carta signed (1215-06-15)", date: "1215-06-15T00:00" },
		{
		...
		{ label: "Berlin Wall built (1961-08-13)", date: "1961-08-13T00:00" },
		{ label: "Chernobyl disaster (1986-04-26)", date: "1986-04-26T01:23" },
		{
	...
	"North America": [
		...
		{ label: "Manahattan Project (1942-08-13)", date: "1942-08-13T00:00" },
		{ label: "First computer (ENIAC, 1945)", date: "1945-12-10T00:00" },
		{ label: "First email sent (1971-10-29)", date: "1971-10-29T00:00" },
		{
	...
	"Asia": [
		...
		{ label: "Meiji Restoration (Japan, 1868)", date: "1868-01-03T00:00" },
		{
	...
	"South America": [
		...
		{ label: "Independence of Brazil (1822)", date: "1822-09-07T00:00" },
		{
	...
	"Middle East": [
		{ label: "Birth of Prophet Muhammad (~570)", date: "0570-04-22T00:00" },
		{ label: "Ottoman Empire founded (1299)", date: "1299-07-27T00:00" },
		{
	...
	"Global": [
		...
		{ label: "United Nations founded (1945)", date: "1945-10-24T00:00" },
